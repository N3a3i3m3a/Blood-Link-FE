...
//       try {
//         const [confirmedResponse, donorsResponse, hospitalsResponse, requestsResponse] = await Promise.all([
//           axios.get('https://blood-link-be.onrender.com/api/appointment/getConfirmedAppointments'),
//           axios.get('https://blood-link-be.onrender.com/api/donor/count'),
//           axios.get('https://blood-link-be.onrender.com/api/hospital/count'),
//           axios.get('https://blood-link-be.onrender.com/api/hospital/bloodRequestCount')
//         ]);
...
//         </div>
//         <div className="pl-4">
//           <span className="text-sm text-gray-500 font-light">Total hospital requests</span>
//           <div className="flex items-center">
