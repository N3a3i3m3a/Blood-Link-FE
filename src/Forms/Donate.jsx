...
const Donate = () => {
  ...
  return (
    <section className='h-fit flex flex-col items-center ml-20 mt-20 justify-center bg-white p-8 shadow-md'>
      <div className='rounded'>
        <h1 className="text-2xl text-gray-500 font-bold">DONATE NOW</h1>
        <h2 className='my-5'>Please, fill in your details to donate blood</h2>
        <form className="flex flex-col gap-5 w-full items-center" onSubmit={handleSubmit}>
          ...
          <button type="submit" className="ml-[10%] bg-red-600 mx-9 py-2 mt-5 rounded-md text-white w-full">
            Donate Now
          </button>
        </form>
      </div>
