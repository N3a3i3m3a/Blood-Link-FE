          ...
          <div className="services1 group">
            ...
            <div className="text1">
              ...
              <button className="px-3 w-full">
                <a href="/" className="p-2 text-white  rounded-2xl bg-red-600">Click Here</a>
              </button>
            </div>
          </div>
        </div>
        <div className="border  rounded-lg p-5 overflow-hidden">
          <div className="services2 group">
            ...
            <div className="text2 ">
              ...
              <button className="px-3 w-full">
                <a href="" className="p-2 rounded-2xl text-white bg-red-600">Click Here</a>
              </button>
            </div>
          </div>
        </div>
        <div className="border  rounded-lg p-5 overflow-hidden">
          <div className="services3 group">
            ...
            <div className="text3">
              ...
              <button className="px-3 w-full">
                <a href="/Hospitals" className="p-2 rounded-2xl text-white bg-red-600">
                  Click Here
                </a>
              </button>
            </div>
